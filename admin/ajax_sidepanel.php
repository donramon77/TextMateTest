...
function saveEmailTemplate(){
    update_option("email_message_signup_details",validate_input($_POST['email_message_signup_details'],true));
    update_option("email_message_signup_confirm",validate_input($_POST['email_message_signup_confirm'],true));
    update_option("email_message_forgot_pass",validate_input($_POST['email_message_forgot_pass'],true));
    update_option("email_message_contact",validate_input($_POST['email_message_contact'],true));
    update_option("email_message_feedback",validate_input($_POST['email_message_feedback'],true));
    update_option("emailHTML_withdraw_accepted",validate_input($_POST['emailHTML_withdraw_accepted'],true));
    update_option("emailHTML_withdraw_rejected",validate_input($_POST['emailHTML_withdraw_rejected'],true));
    update_option("emailHTML_withdraw_request",validate_input($_POST['emailHTML_withdraw_request'],true));
...
function SaveSettings(){
    ...
    if (isset($_POST['valid_purchase_setting'])) {
        ...
        $url = "https://code.gives/quickai/api.txt?verify-purchase=" . $code . "&version=" . $installing_version . "&site_url=". $config['site_url']."&email=" . $buyer_email;
        // Open cURL channel
        $ch = curl_init();
